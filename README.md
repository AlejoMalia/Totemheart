...
[![Tests](https://img.shields.io/badge/tests-2794%20passing-brightgreen?style=plastic)](test)
[![Mechanisms verified](https://img.shields.io/badge/mechanisms-79%20verified%20%2F%2017%20covered%20%2F%200%20failed-brightgreen?style=plastic)](examples/verify-all-mechanisms.js)
...
`npm run verify` ([`examples/verify-all-mechanisms.js`](examples/verify-all-mechanisms.js)): 79 mechanics verified live/direct, 17 covered by other modules (including every mechanism added in 1.6.0, the 21 "Round B" mechanisms from round 9, the 5 indispensable-human-mechanism additions from round 16, the 6 mechanisms found by auditing this project's own citations from round 17, and dreams/the subconscious from round 18), 0 left blank. Full citation ledger, by theme: [`CALIBRATION.md`](CALIBRATION.md).
